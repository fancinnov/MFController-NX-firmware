...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM17_MspInit 0 */
    ...
    PB9     ------> TIM17_CH1
    */
    GPIO_InitStruct.Pin = PPM_INPUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM17;
    HAL_GPIO_Init(PPM_INPUT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE14     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = FMU_MOTOR_4_Pin|FMU_MOTOR_3_Pin|FMU_MOTOR_2_Pin|FMU_MOTOR_1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM17_MspDeInit 0 */
    ...
    PB9     ------> TIM17_CH1
    */
    HAL_GPIO_DeInit(PPM_INPUT_GPIO_Port, PPM_INPUT_Pin);
